...
function Carousel() {
  ...
  return (
    <section
      id="landing-carousel"
      className="relative overflow-hidden flex items-center justify-center pt-[74px]"
    >
      <AutoSlider imgs={imgs} />

      <div className="absolute px-7 w-full h-full flex flex-col items-center justify-center top-0 bg-dark text-light bg-opacity-90 lg:items-start md:pl-18 lg:pl-28 xl:pl-56">
        <h1 className="text-6xl font-extrabold text-center md:text-8xl">
          EXERCISE{" "}
          <span className="text-8xl md:text-8xl sm:text-6xl">
            FTUI
          </span>
        </h1>

        <p className="w-[85%] max-w-2xl mt-12 font-light text-center md:text-lg lg:text-justify xl:text-xl">
