...
function WhatsInOurHands() {
  return (
    <div id="landing-whats-in-our-hands-section" className="py-20">
      <div className="site-wrapper w-container">
        <p className="section-head font-light text-grey-2 text-5xl xl:text-6xl">
          What's in Our Hands?
        </p>
        ...
        <div className="w-fit flex flex-wrap justify-center gap-6 md:gap-12">
          {icons.map(({ img, title }, i) => (
            <div
              key={i}
              className="group bg-grey-2 cursor-alias duration-300 ease-out w-36 h-36 p-4 flex-center text-center hover:bg-opacity-0 md:w-44 md:h-44 xl:w-48 xl:h-48"
            >
              <img
                alt={title + " Icon"}
                src={img}
